...
let testURL =
  "https://gaia.blockstack.org/hub/1NkTNTS6VhP2VEVyU84w3spmYgk2bi8tRp/test.txt";
...
Clarinet.test({
  ...
  async fn(chain: Chain, accounts: Map<string, Account>) {
    ...
    tuple["data-owner"].expectPrincipal(
      address1
    ); /* Can also check the same with assertEquals. What is better?*/
  ...
  async fn(chain: Chain, accounts: Map<string, Account>) {
    ...
    block = chain.mineBlock([
      Tx.contractCall(
        "rolesAccess",
        "add-data-accessor",
        [types.ascii(testURL), types.principal(address2)],
        address1
      ),
    ]);
    let inner = block.receipts[0].result.expectOk();
    ...
    block = chain.mineBlock([
      Tx.contractCall(
        "rolesAccess",
        "add-data-accessor",
        [types.ascii(testURL), types.principal(address3)],
        address1
      ),
    ]);
    ...
    block = chain.mineBlock([
      Tx.contractCall(
        "rolesAccess",
        "add-data-accessor",
        [types.ascii(testURL), types.principal(address4)],
        address1
      ),
    ]);
    block = chain.mineBlock([
      Tx.contractCall(
        "rolesAccess",
        "add-data-accessor",
        [types.ascii(testURL), types.principal(address5)],
        address1
      ),
    ]);
    block = chain.mineBlock([
      Tx.contractCall(
        "rolesAccess",
        "add-data-accessor",
        [types.ascii(testURL), types.principal(address6)],
        address1
      ),
    ]);
    block = chain.mineBlock([
      Tx.contractCall(
        "rolesAccess",
        "add-data-accessor",
        [types.ascii(testURL), types.principal(address7)],
        address1
      ),
    ]);
    block = chain.mineBlock([
      Tx.contractCall(
        "rolesAccess",
        "add-data-accessor",
        [types.ascii(testURL), types.principal(address8)],
        address1
      ),
    ]);
    block = chain.mineBlock([
      Tx.contractCall(
        "rolesAccess",
        "add-data-accessor",
        [types.ascii(testURL), types.principal(address9)],
        address1
      ),
    ]);
    block = chain.mineBlock([
      Tx.contractCall(
        ...
        [
          types.ascii(testURL),
          types.principal("ST12KV4C80N0FN2B3JVPB8ZTVEXCXETYHB10WMQB9"),
        ],
        address1
      ),
    ]);
    block = chain.mineBlock([
      Tx.contractCall(
        ...
        [
          types.ascii(testURL),
          types.principal("ST32SMX34VSNJ8DZE88JDT067Y98THRC5XBGS5S69"),
        ],
        address1
      ),
    ]);
    ...
    block = chain.mineBlock([
      Tx.contractCall(
        ...
        [
          types.ascii(testURL),
          types.principal("ST36K3XANWMRK91VZRE4EQMKSPMEN24N9EBG4TTJD"),
        ],
        address1
      ),
    ]);
